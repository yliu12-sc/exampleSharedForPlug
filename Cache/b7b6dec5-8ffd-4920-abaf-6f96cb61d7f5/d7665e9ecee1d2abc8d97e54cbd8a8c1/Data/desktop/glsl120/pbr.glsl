...
int l9_1=l9_0+1;
int l9_2=l9_0+2;
return mat4x3(vec3(sc_BoneMatrices[l9_0].x,sc_BoneMatrices[l9_1].x,sc_BoneMatrices[l9_2].x),vec3(sc_BoneMatrices[l9_0].y,sc_BoneMatrices[l9_1].y,sc_BoneMatrices[l9_2].y),vec3(sc_BoneMatrices[l9_0].z,sc_BoneMatrices[l9_1].z,sc_BoneMatrices[l9_2].z),vec3(sc_BoneMatrices[l9_0].w,sc_BoneMatrices[l9_1].w,sc_BoneMatrices[l9_2].w));
}
...
{
l9_0=sc_SkinBonesNormalMatrices[index];
}
#else
{
l9_0=mat3(0.0);
...
#if (sc_SkinBonesCount>0)
{
vec4 l9_23=vec4(1.0,fract(boneData.yzw));
vec4 l9_24=l9_23;
l9_24.x=1.0-dot(l9_23.yzw,vec3(1.0));
l9_22=l9_24;
}
#else
{
...
#endif
int l9_25=sc_GetBoneIndex(0);
int l9_26=sc_GetBoneIndex(1);
int l9_27=sc_GetBoneIndex(2);
int l9_28=sc_GetBoneIndex(3);
vec3 l9_29=skinVertexPosition(l9_25,l9_10);
vec3 l9_30=skinVertexPosition(l9_26,l9_10);
vec3 l9_31=skinVertexPosition(l9_27,l9_10);
vec3 l9_32=skinVertexPosition(l9_28,l9_10);
vec3 l9_33=(((l9_29*l9_22.x)+(l9_30*l9_22.y))+(l9_31*l9_22.z))+(l9_32*l9_22.w);
vec4 l9_34=vec4(l9_33.x,l9_33.y,l9_33.z,l9_10.w);
mat3 l9_35=sc_GetNormalMatrix(l9_25);
mat3 l9_36=sc_GetNormalMatrix(l9_26);
mat3 l9_37=sc_GetNormalMatrix(l9_27);
mat3 l9_38=sc_GetNormalMatrix(l9_28);
vec3 l9_39;
#if (!STD_DISABLE_VERTEX_NORMAL)
{
l9_39=((((l9_35*l9_9)*l9_22.x)+((l9_36*l9_9)*l9_22.y))+((l9_37*l9_9)*l9_22.z))+((l9_38*l9_9)*l9_22.w);
}
#else
{
l9_39=l9_9;
...
#if (!STD_DISABLE_VERTEX_TANGENT)
{
l9_40=((((l9_35*l9_8)*l9_22.x)+((l9_36*l9_8)*l9_22.y))+((l9_37*l9_8)*l9_22.z))+((l9_38*l9_8)*l9_22.w);
}
#else
{
l9_40=l9_8;
...
vec3 l9_41=sc_NormalMatrix*l9_19;
varTangent=vec4(l9_41.x,l9_41.y,l9_41.z,varTangent.w);
}
#endif
}
#endif
...
varColor=color;
vec3 l9_45=varPos;
vec3 l9_46=varNormal;
vec3 l9_47;
vec3 l9_48;
vec3 l9_49;
if (l9_42)
{
l9_49=varTangent.xyz;
l9_48=varNormal;
l9_47=varPos;
}
else
...
varPos=l9_47;
varNormal=normalize(l9_48);
vec3 l9_50=normalize(l9_49);
varTangent=vec4(l9_50.x,l9_50.y,l9_50.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_51=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_21;
}
#else
{
vec4 l9_52;
#if (sc_RenderingSpace==2)
{
l9_52=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_21;
}
#else
{
vec4 l9_53;
#if (sc_RenderingSpace==1)
{
l9_53=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_21;
}
#else
{
l9_53=l9_21;
...
#if (sc_RenderingSpace==4)
{
l9_55=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_21)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_56;
#if (sc_RenderingSpace==2)
{
l9_56=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
vec4 l9_57;
...
#endif
varPackedTex=vec4(l9_43,l9_6);
#if (sc_ProjectiveShadowsReceiver)
{
vec4 l9_58;
#if (sc_RenderingSpace==1)
{
l9_58=sc_ModelMatrix*l9_21;
}
#else
{
l9_58=l9_21;
...
#endif
vec4 l9_59=sc_ProjectorMatrix*l9_58;
...
{
vec4 l9_61=l9_54;
l9_61.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_54.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_54.w;
l9_60=l9_61;
}
#else
{
...
vec2 l9_1=vec2(0.0);
l9_1.x=(((reflDir.x<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_0/length(vec2(reflDir.x,l9_0)),-1.0,1.0)))-1.5708;
vec2 l9_2=l9_1;
l9_2.y=acos(reflDir.y);
vec2 l9_3=l9_2*vec2(0.159155,0.31831);
vec2 l9_4=l9_3;
l9_4.y=1.0-l9_3.y;
float l9_5=l9_3.x+(rotationDegrees*0.00277778);
vec2 l9_6=l9_4;
l9_6.x=fract((l9_5+floor(l9_5))+1.0);
return l9_6;
}
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
vec4 l9_0=(vec4(-1.0,-0.0275,-0.572,0.022)*surfaceProperties.roughness)+vec4(1.0,0.0425,1.04,-0.04);
float l9_1=l9_0.x;
vec2 l9_2=(vec2(-1.04,1.04)*((min(l9_1*l9_1,exp2((-9.28)*NdotV))*l9_1)+l9_0.y))+l9_0.zw;
...
#else
{
return (x*((x*1.8)+vec3(1.4)))/min(vec3(1000.0),(x*((x*1.8)+vec3(0.5)))+vec3(1.5));
}
#endif
}
...
l9_1.y=target.y;
vec3 l9_2=l9_1;
l9_2.z=RGBToHSL(original).z;
return mix(original,HSLToRGB(l9_2),vec3(weight));
}
#else
{
vec3 l9_3=vec3(0.0);
l9_3.x=transformSingleColor(yValue,intMap,target.x);
vec3 l9_4=l9_3;
l9_4.y=transformSingleColor(yValue,intMap,target.y);
vec3 l9_5=l9_4;
l9_5.z=transformSingleColor(yValue,intMap,target.z);
return mix(original,clamp(l9_5,vec3(0.0),vec3(1.0)),vec3(weight));
}
#endif
}
...
vec3 l9_45=a;
vec3 l9_46=b;
float l9_47=((0.299*l9_45.x)+(0.587*l9_45.y))+(0.114*l9_45.z);
int l9_48;
...
float l9_50=(((l9_49.x*256.0)+l9_49.y)+(l9_49.z*0.00390625))*0.0622559;
float l9_51;
...
{
l9_10=mat3(l9_1,cross(l9_2,l9_1)*varTangent.w,l9_2)*((l9_7.xyz*1.99219)-vec3(1.0)).xyz;
}
#else
{
l9_10=vec3(0.0);
...
{
if (l9_11<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
vec3 l9_21=mix(vec3(0.04),l9_16*l9_14,l9_20);
...
#endif
l9_77=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_78,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#else
{
vec4 l9_79;
...
#else
{
l9_79=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_76,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#endif
l9_77=l9_79;
}
...
float l9_85=l9_83.y;
float l9_86=l9_83.z;
l9_82=(((((((sc_Sh[8]*0.429043)*((l9_84*l9_84)-(l9_85*l9_85)))+((sc_Sh[6]*0.743125)*(l9_86*l9_86)))+(sc_Sh[0]*0.886227))-(sc_Sh[6]*0.247708))+((((sc_Sh[4]*(l9_84*l9_85))+(sc_Sh[7]*(l9_84*l9_86)))+(sc_Sh[5]*(l9_85*l9_86)))*0.858086))+((((sc_Sh[3]*l9_84)+(sc_Sh[1]*l9_85))+(sc_Sh[2]*l9_86))*1.02333))*sc_ShIntensity;
}
#else
{
l9_82=vec3(0.0);
...
float l9_106=0.36*l9_100;
float l9_107=0.694444*l9_105;
...
l9_98=l9_97+((((sc_LightEstimationData.sg[l9_99].color/vec3(sc_LightEstimationData.sg[l9_99].sharpness))*6.28319)*((l9_104*l9_109)+(((l9_101-l9_102)*l9_103)-l9_102)))*vec3(0.31831));
l9_97=l9_98;
l9_99++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_111=clamp(pow(l9_15,0.666667),0.0,1.0)*5.0;
...
#endif
l9_110=(((l9_113.xyz*(1.0/l9_113.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_23,abs(dot(l9_17,l9_0)));
}
#else
{
l9_110=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_117=clamp(l9_15*l9_15,0.01,1.0);
vec3 l9_118;
...
float l9_123=(2.0/l9_120)/(4.0*max(l9_122,0.0001));
...
l9_118+=((((((((vec3(0.31831/l9_120)*exp((l9_124-l9_123)-sc_LightEstimationData.sg[l9_119].sharpness))*sc_LightEstimationData.sg[l9_119].color)*6.28319)*(1.0-exp((-2.0)*l9_124)))/vec3(l9_124))*((1.0/(l9_125+sqrt(l9_120+((l9_127*l9_125)*l9_125))))*(1.0/(l9_126+sqrt(l9_120+((l9_127*l9_126)*l9_126))))))*(l9_21+((vec3(1.0)-l9_21)*pow(1.0-clamp(dot(l9_121,normalize(l9_121+l9_0)),0.0,1.0),5.0))))*l9_125);
l9_119++;
continue;
}
else
...
{
vec4 l9_144=l9_142;
l9_144.x=l9_141+((l9_19.x*Port_SpecularAO_N006.x)*1e-05);
l9_143=l9_144;
}
#else
{
...
{
vec3 l9_146=linearToneMapping(l9_143.xyz);
l9_145=vec4(l9_146.x,l9_146.y,l9_146.z,l9_143.w);
}
#else
{
l9_145=l9_143;
...
#endif
vec3 l9_147=vec3(linearToSrgb(l9_145.x),linearToSrgb(l9_145.y),linearToSrgb(l9_145.z));
l9_13=vec4(l9_147.x,l9_147.y,l9_147.z,l9_145.w);
}
#else
{
...
#endif
vec4 l9_148=max(l9_13,vec4(0.0));
vec4 l9_149;
#if (sc_ProjectiveShadowsCaster)
{
float l9_150;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_151=clamp(l9_148.w*2.0,0.0,1.0);
}
#else
{
float l9_152;
...
{
l9_152=clamp(dot(l9_148.xyz,vec3(l9_148.w)),0.0,1.0);
}
#else
{
float l9_153;
...
#if (sc_BlendMode_Multiply)
{
l9_154=(1.0-dot(l9_148.xyz,vec3(0.33333)))*l9_148.w;
}
#else
{
float l9_155;
...
{
l9_155=(1.0-clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0))*l9_148.w;
}
#else
{
float l9_156;
#if (sc_BlendMode_ColoredGlass)
{
l9_156=clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0)*l9_148.w;
}
#else
{
float l9_157;
#if (sc_BlendMode_Add)
{
l9_157=clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_158;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_158=clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0)*l9_148.w;
}
#else
{
float l9_159;
...
{
l9_159=dot(l9_148.xyz,vec3(0.33333))*l9_148.w;
}
#else
{
float l9_160;
#if (sc_BlendMode_Min)
{
l9_160=1.0-clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_161;
#if (sc_BlendMode_Max)
{
l9_161=clamp(dot(l9_148.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_161=1.0;
...
#endif
l9_149=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_148.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_150);
}
#else
{
vec4 l9_162;
...
{
vec3 l9_164=sc_GetFramebufferColor().xyz;
vec3 l9_165=mix(l9_164,definedBlend(l9_164,l9_148.xyz).xyz,vec3(l9_148.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_168=l9_148.w;
l9_167=vec4(mix(vec3(1.0),l9_148.xyz,vec3(l9_168)),l9_168);
}
#else
{
vec4 l9_169;
...
{
float l9_170=l9_148.w;
float l9_171;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_171=clamp(l9_170,0.0,1.0);
}
#else
{
l9_171=l9_170;
...
#endif
l9_169=vec4(l9_148.xyz*l9_171,l9_171);
}
#else
{
l9_169=l9_148;
...
{
l9_174=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_174=vec4(0.0);
...
vec4 l9_176=max(l9_175,vec4(0.0));
...
#if (sc_OITDepthBoundsPass)
{
float l9_178=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_178),min(1.0,l9_178+0.00392157),0.0,0.0));
}
#endif
}
#else
...
vec4 l9_182=vec4(0.0);
l9_182.x=l9_181;
vec4 l9_184=l9_182;
l9_184.y=packValue(l9_180);
vec4 l9_186=l9_184;
l9_186.z=packValue(l9_180);
vec4 l9_188=l9_186;
l9_188.w=packValue(l9_180);
vec4 l9_190=vec4(0.0);
l9_190.x=packValue(l9_180);
vec4 l9_192=l9_190;
l9_192.y=packValue(l9_180);
vec4 l9_194=l9_192;
l9_194.z=packValue(l9_180);
vec4 l9_195=l9_194;
l9_195.w=packValue(l9_180);
int l9_196=int(l9_177.w*255.0);
float l9_197=packValue(l9_196);
vec4 l9_198=vec4(0.0);
l9_198.x=l9_197;
vec4 l9_200=l9_198;
l9_200.y=packValue(l9_196);
vec4 l9_202=l9_200;
l9_202.z=packValue(l9_196);
vec4 l9_203=l9_202;
l9_203.w=packValue(l9_196);
sc_writeFragData0(l9_195);
sc_writeFragData1(l9_188);
sc_writeFragData2(l9_203);
...
#if (sc_OITCompositingPass)
{
vec2 l9_204=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_215==0)
{
l9_218=texture2D(sc_OITAlpha0,l9_204);
l9_217=texture2D(sc_OITDepthLow0,l9_204);
l9_216=texture2D(sc_OITDepthHigh0,l9_204);
}
else
{
l9_218=l9_211;
...
if (l9_215==1)
{
l9_214=texture2D(sc_OITAlpha1,l9_204);
l9_213=texture2D(sc_OITDepthLow1,l9_204);
l9_212=texture2D(sc_OITDepthHigh1,l9_204);
}
else
{
l9_214=l9_218;
...
{
int l9_219[8]=l9_205;
unpackValues(l9_212.w,l9_215,l9_219);
unpackValues(l9_212.z,l9_215,l9_219);
unpackValues(l9_212.y,l9_215,l9_219);
unpackValues(l9_212.x,l9_215,l9_219);
unpackValues(l9_213.w,l9_215,l9_219);
unpackValues(l9_213.z,l9_215,l9_219);
unpackValues(l9_213.y,l9_215,l9_219);
unpackValues(l9_213.x,l9_215,l9_219);
int l9_228[8]=l9_206;
unpackValues(l9_214.w,l9_215,l9_228);
unpackValues(l9_214.z,l9_215,l9_228);
unpackValues(l9_214.y,l9_215,l9_228);
unpackValues(l9_214.x,l9_215,l9_228);
}
l9_211=l9_214;
l9_210=l9_213;
l9_209=l9_212;
...
vec4 l9_233=texture2D(sc_OITFilteredDepthBoundsTexture,l9_204);
...
if (l9_243)
{
vec3 l9_244=l9_237.xyz*(1.0-(float(l9_206[l9_239])*0.00392157));
