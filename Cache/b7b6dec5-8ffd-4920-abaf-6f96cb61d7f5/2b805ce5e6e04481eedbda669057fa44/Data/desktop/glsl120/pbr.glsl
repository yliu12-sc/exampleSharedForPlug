...
vec2 l9_1=vec2(0.0);
l9_1.x=(((reflDir.x<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_0/length(vec2(reflDir.x,l9_0)),-1.0,1.0)))-1.5707964;
vec2 l9_2=l9_1;
l9_2.y=acos(reflDir.y);
vec2 l9_3=l9_2*vec2(0.15915494,0.31830987);
vec2 l9_4=l9_3;
l9_4.y=1.0-l9_3.y;
float l9_5=l9_3.x+(rotationDegrees*0.0027777778);
vec2 l9_6=l9_4;
...
return vec3(l9_0.x,l9_1/(1.0000001-abs((2.0*l9_2)-1.0)),l9_2);
}
...
float l9_50=(((l9_49.x*256.0)+l9_49.y)+(l9_49.z*0.00390625))*0.062255863;
float l9_51;
...
int l9_0=value;
value/=4;
return floor(floor(mod(float(l9_0),4.0))*64.0)*0.0039215689;
}
#else
{
return 0.0;
...
{
if (l9_11<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.05882353))
{
discard;
}
}
...
float l9_107=0.69444442*l9_105;
...
l9_98=l9_97+((((sc_LightEstimationData.sg[l9_99].color/vec3(sc_LightEstimationData.sg[l9_99].sharpness))*6.2831855)*((l9_104*l9_109)+(((l9_101-l9_102)*l9_103)-l9_102)))*vec3(0.31830987));
l9_97=l9_98;
l9_99++;
continue;
}
...
#if (sc_BlendMode_Multiply)
{
l9_154=(1.0-dot(l9_148.xyz,vec3(0.33333001)))*l9_148.w;
}
#else
{
float l9_155;
...
{
l9_159=dot(l9_148.xyz,vec3(0.33333001))*l9_148.w;
}
#else
{
float l9_160;
...
{
l9_174=vec4(shaderComplexityValue*0.0039215689,0.0,0.0,1.0);
}
#else
{
l9_174=vec4(0.0);
...
sc_writeFragData0(vec4(max(0.0,1.0039216-l9_178),min(1.0,l9_178+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
if (l9_243)
{
vec3 l9_244=l9_237.xyz*(1.0-(float(l9_206[l9_239])*0.0039215689));
