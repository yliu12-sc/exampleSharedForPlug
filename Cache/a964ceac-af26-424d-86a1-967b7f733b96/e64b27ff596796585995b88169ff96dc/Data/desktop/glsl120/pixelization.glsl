...
{
if (l9_6<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.05882353))
{
discard;
}
}
...
{
l9_37=vec4(shaderComplexityValue*0.0039215689,0.0,0.0,1.0);
}
#else
{
l9_37=vec4(0.0);
...
sc_writeFragData0(vec4(max(0.0,1.0039216-l9_41),min(1.0,l9_41+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
if (l9_106)
{
vec3 l9_107=l9_100.xyz*(1.0-(float(l9_69[l9_102])*0.0039215689));
