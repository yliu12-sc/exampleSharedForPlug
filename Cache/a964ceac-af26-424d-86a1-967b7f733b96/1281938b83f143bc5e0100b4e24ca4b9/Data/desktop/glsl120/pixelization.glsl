...
//sampler sampler screenTextureSmpSC 2:24
...
//texture texture2D screenTexture 2:15:2:24
//SG_REFLECTION_END
...
vec2 l9_2=vec2(0.0);
l9_2.x=sc_Camera.aspect*pixelOffset;
vec2 l9_3=l9_2;
l9_3.y=pixelOffset;
int l9_4;
...
{
if (l9_6<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
{
l9_12=(1.0-dot(l9_5.xyz,vec3(0.33333)))*l9_6;
}
#else
{
float l9_13;
...
{
l9_17=dot(l9_5.xyz,vec3(0.33333))*l9_6;
}
#else
{
float l9_18;
...
#else
{
vec2 l9_26=sc_ScreenCoordsGlobalToView(l9_0);
int l9_27;
...
{
l9_37=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_37=vec4(0.0);
...
#if (sc_OITDepthBoundsPass)
{
float l9_41=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_41),min(1.0,l9_41+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_42=sc_ScreenCoordsGlobalToView(l9_0);
...
l9_45.x=l9_44;
vec4 l9_47=l9_45;
l9_47.y=packValue(l9_43);
vec4 l9_49=l9_47;
l9_49.z=packValue(l9_43);
vec4 l9_51=l9_49;
l9_51.w=packValue(l9_43);
vec4 l9_53=vec4(0.0);
l9_53.x=packValue(l9_43);
vec4 l9_55=l9_53;
l9_55.y=packValue(l9_43);
vec4 l9_57=l9_55;
l9_57.z=packValue(l9_43);
vec4 l9_58=l9_57;
l9_58.w=packValue(l9_43);
int l9_59=int(l9_40.w*255.0);
float l9_60=packValue(l9_59);
vec4 l9_61=vec4(0.0);
l9_61.x=l9_60;
vec4 l9_63=l9_61;
l9_63.y=packValue(l9_59);
vec4 l9_65=l9_63;
l9_65.z=packValue(l9_59);
vec4 l9_66=l9_65;
l9_66.w=packValue(l9_59);
sc_writeFragData0(l9_58);
sc_writeFragData1(l9_51);
sc_writeFragData2(l9_66);
...
#if (sc_OITCompositingPass)
{
vec2 l9_67=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_78==0)
{
l9_81=texture2D(sc_OITAlpha0,l9_67);
l9_80=texture2D(sc_OITDepthLow0,l9_67);
l9_79=texture2D(sc_OITDepthHigh0,l9_67);
}
else
{
l9_81=l9_74;
...
if (l9_78==1)
{
l9_77=texture2D(sc_OITAlpha1,l9_67);
l9_76=texture2D(sc_OITDepthLow1,l9_67);
l9_75=texture2D(sc_OITDepthHigh1,l9_67);
}
else
{
l9_77=l9_81;
...
{
int l9_82[8]=l9_68;
unpackValues(l9_75.w,l9_78,l9_82);
unpackValues(l9_75.z,l9_78,l9_82);
unpackValues(l9_75.y,l9_78,l9_82);
unpackValues(l9_75.x,l9_78,l9_82);
unpackValues(l9_76.w,l9_78,l9_82);
unpackValues(l9_76.z,l9_78,l9_82);
unpackValues(l9_76.y,l9_78,l9_82);
unpackValues(l9_76.x,l9_78,l9_82);
int l9_91[8]=l9_69;
unpackValues(l9_77.w,l9_78,l9_91);
unpackValues(l9_77.z,l9_78,l9_91);
unpackValues(l9_77.y,l9_78,l9_91);
unpackValues(l9_77.x,l9_78,l9_91);
}
l9_74=l9_77;
l9_73=l9_76;
l9_72=l9_75;
...
vec4 l9_96=texture2D(sc_OITFilteredDepthBoundsTexture,l9_67);
vec2 l9_97=l9_96.xy;
int l9_98;
#if (sc_SkinBonesCount>0)
{
...
if (l9_106)
{
vec3 l9_107=l9_100.xyz*(1.0-(float(l9_69[l9_102])*0.00392157));
