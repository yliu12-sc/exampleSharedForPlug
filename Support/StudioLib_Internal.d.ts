// Lens Studio Version: 5.0.4 (Internal)
// Snapchat Version: 12.69 (Internal)
...
/**
* @description The base class for data accessible through [DataComponent](https://lensstudio.snapchat.com/api/lens-studio/Classes/Components#DataComponent).
*/
...
/**
* @description Interface for sending Blizzard analytics events. Accessible from [DataComponent](https://lensstudio.snapchat.com/api/lens-studio/Classes/ScriptObjects#DataComponent).
*/
...
interface AnimationCurveTrack extends ScriptObject {
...
interface BitmojiModule extends Asset {
    ...
    */
    ...
    createBitmoji3DResourceForUserWithParams(user: SnapchatUser, params: any): Bitmoji3DResource
...
interface FaceInsetVisual extends MaterialMeshVisual {
    setBarycentricCoordinates(coordsJS: unknown[]): void
...
interface GaussianSplattingVisual extends BaseMeshVisual {
...
interface GestureModule extends Asset {
    void(gestureId: number, confidence: number, position): vec3): any
    
    void(gestureId: number, finger: GestureModule.FingerType, confidence: number, position): vec3): any
    
    void(gestureId: number, beginTimestamp: number, finger: GestureModule.FingerType, confidence: number, beginPositions: vec3, currentPosition): vec3): any
    
    void(gestureId: number, finger: GestureModule.FingerType, confidence: number, position): vec3): any
    
    void(locus: vec3, direction): vec3): any
    
    void(confidence): number): any
...
* @description This class has been **Deprecated**. Please instead use the [DeviceTracking](https://lensstudio.snapchat.com/api/lens-studio/Classes/Components#DeviceTracking) component with Tracking Mode set to Rotation.
* See the [Tracking Modes](https://lensstudio.snapchat.com/lens-studio/references/guides/lens-features/tracking/world/tracking-modes) guide for more information.
...
interface RemoteMediaModule extends Asset {
    ...
    */
    ...
    createImageResourceForTexture(texture: Texture, uploadOptions: ImageUploadOptions): any
...
interface RenderMeshVisual extends MaterialMeshVisual {
    ...
    * @description The [BlendShapes](https://lensstudio.snapchat.com/api/lens-studio/Classes/Components#BlendShapes) component used for rendering this mesh.
    */
...
declare namespace Trace {
    export function event(sliceName: string, function: () => void): void
